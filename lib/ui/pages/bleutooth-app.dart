...
class bleutoothApp extends StatefulWidget {
  const bleutoothApp({Key? key}) : super(key: key);

  @override
  State<bleutoothApp> createState() => _bleutoothAppState();
}

class _bleutoothAppState extends State<bleutoothApp> {
  ...
  Map<String, Color> colors = {
    ...
    'offTextColor': Colors.red.shade400,
