...
class notfoundgps extends StatefulWidget {
  const notfoundgps({Key? key}) : super(key: key);

  @override
  State<notfoundgps> createState() => _notfoundgpsState();
}

class _notfoundgpsState extends State<notfoundgps>with SingleTickerProviderStateMixin {
