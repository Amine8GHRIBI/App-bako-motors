...
import 'package:mini_project/ui/pages/meteo_page/Home.dart';
            ...
            child: Row(
              children: [
                GestureDetector(
                    ...
                    child: Image.asset(cities[index].isSelected == true ? 'assets/weather_image/checked.png' : 'assets/weather_image/unchecked.png', width: 30,)),
