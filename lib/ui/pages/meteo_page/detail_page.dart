...
import 'package:mini_project/ui/pages/meteo_page/welcome.dart';
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Image.asset(
                            'assets/weather_image/' + weatherURL + ".png",
                            width: 40,
                          ),
                          Text(
                            newDate,
                      ...
                      child: Stack(
                        ...
                        children: [
                          Positioned(
                            ...
                            left: 20,
                            child: Image.asset(
                              'assets/weather_image/' + imageUrl + '.png',
                              width: 150,
                            ),
                          ),
                          Positioned(
                                ...
                                children: [
                                  weatherItem(
                                    ...
                                    ['wind_speed']
                                        .round(),
                                    unit: 'km/h',
                                    imageUrl: 'assets/weather_image/windspeed.png',
                                  ),
                                  weatherItem(
                                      text: 'Humidity',
                                      ...
                                      selectedIndex]['humidity']
                                          .round(),
                                      unit: '',
                                      imageUrl: 'assets/weather_image/humidity.png'),
                                  weatherItem(
                                    text: 'Max Temp',
                                    value: widget
                                        .consolidatedWeatherList[selectedIndex]
                                    ['max_temp']
                                        .round(),
                                    unit: 'C',
                                    imageUrl: 'assets/weather_image/max-temp.png',
                                  ),
                                ],
                              ),
                            ),
